...
# data loader
parser.add_argument('--data', type=str, default='qinghaigenerationdata', help='dataset type')
parser.add_argument('--root_path', type=str, default='./data/', help='root path')
parser.add_argument('--data_path', type=str, default='generation_solar_power.csv', help='data file')
parser.add_argument('--generation_type', type=str, default='solar_power')
parser.add_argument('--weather_enc_in', type=int, default=7)
